 ...
 * ConfigManager
 *
 * Centralises all runtime configuration. Values are injected as JVM system
 * properties by Maven Surefire, which in turn reads them from the GitHub
 * Actions workflow inputs passed via the repository_dispatch payload.
 *
...
public class ConfigManager {
	...
	/**
	 * URL of the application under test. Injected as -Dapp.url in CI; falls back to
	 * localhost for local runs.
	 */
	public static String getAppUrl() {
		// return System.getProperty("app.url", "http://localhost:8080");
		return "https://srinivasbandi1.github.io/taskflow-app/";
	}
	...
	/**
	 * Whether to run in headless mode. Always true in CI; can be overridden
	 * locally.
	 */
